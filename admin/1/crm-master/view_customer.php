...
<div class="row">
	<div class="col-sm-3">
		<ul class="nav flex-column">
			...
			<li class="nav-item">
				<a href="view_customer.php" class="nav-link"  style="background-color: #2D7495;color: white;">View Customer</a>
			</li>
			<li class="nav-item">
				<a href="edit_customer.php" class="nav-link">Edit Customer</a>
			</li>
			<li class="nav-item">
				<a href="delete_customer.php" class="nav-link">Delete Customer</a>
			</li>
			<li class="nav-item">
