...
if(verifyuser())
{
	...
	$un=fetchusername();
	$msg="Welcome $un , <br /><a href='index.php'>Signout</a>";
...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="top.html">TG : <?php echo $msg; ?></a>
      ...
      <ul class="sidebar navbar-nav">
       ...
       <li class="nav-item dropdown">
		...
		<li class="nav-item">
          <a class="nav-link" href="uploadstudentlist.php">
            <i class="fas fa-fw fa-chart-area"></i>
            <span>UPLOAD EXCEL FILE</span></a>
        </li>
